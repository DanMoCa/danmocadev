...
import PageToast from "@/Components/PageToast.jsx";
...
const user = {
    ...
    imageUrl:
        'https://pbs.twimg.com/profile_images/1570282197478739969/eKYIX6qh_400x400.jpg',
}
const navigation = [
    { name: 'Home', href: route('home'), current: 'home' },
    { name: 'Sobre mi', href: route('about'), current: 'about' },
    { name: 'Proyectos', href: route('projects.index'), current: 'projects.index' },
...
export default function MainLayout({children, pageName, title = "", ...props}) {
    ...
    return (
        <>
            ...
            <div className={"min-h-screen flex flex-col"}>
                ...
                <div className="flex-1 bg-white dark:bg-gray-900 ease-in duration-300">
